...
CREATE OR REPLACE file format MANAGE_DB.FILE_FORMATS.JSONFORAMT
    TYPE = JSON;
...
COPY INTO OUR_FIRST_DB.PUBLIC.JSON_RAW
     ...
     file_format= MANAGE_DB.FILE_FORMATS.JSONFORAMT
     files= ('HR_data.json');

SELECT * FROM OUR_FIRST_DB.PUBLIC.JSON_RAW;

SELECT * FROM $1:city City, $1:first_name::string Firstname FROM OUR_FIRST_DB.PUBLIC.JSON_RAW;
